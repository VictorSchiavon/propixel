...
export const metadata: Metadata = {
    title: "Host de Arma 3 no Brasil",
    description: "A melhor hospedagem de Arma 3 no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'Host de Arma 3 - Hospedagem de Arma 3 | RazeHost',
        description: 'A melhor hospedagem de Arma 3 no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.',
        url: 'https://www.razehost.com.br/arma-3',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
