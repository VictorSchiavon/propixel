...
export const metadata: Metadata = {
    title: "VPS Dayz no Brasil",
    description: "A melhor VPS de Dayz no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.",
    keywords: [
        "RazeHost.com.br",
        "RazeHost",
        "Raze Host",
    ...
    openGraph: {
        ...
        url: 'https://www.razehost.com.br/dayz',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
