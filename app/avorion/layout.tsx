...
export const metadata: Metadata = {
    title: "Host de Avorion no Brasil",
    description: "A melhor hospedagem de Avorion no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'Host de Avorion - Hospedagem de Avorion | RazeHost',
        description: 'A melhor hospedagem de Avorion no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.',
        url: 'https://www.razehost.com.br/avorion',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
