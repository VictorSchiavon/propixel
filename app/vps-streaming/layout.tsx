...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "VPS para Streaming",
    "VPS para Streaming Brasil",
    "VPS para Streaming com anti DDoS",
    "VPS Brasil",
    "VPS no Brasil",
    "VPS Ryzen",
    "VPS para Streaming Ryzen",
    "VPS para FiveM",
    "VPS Windows",
    "VPS Linux",
    "VPS barato",
    ...
    openGraph: {
        title: 'VPS para Streaming no Brasil | RazeHost',
        description: 'VPS para Streaming com processadores AMD Ryzen e Proteção Anti DDoS para aplicações de alto nível e servidores de jogos.',
    ...
    twitter: {
        ...
        title: 'VPS para Streaming no Brasil com Anti DDoS | RazeHost',
        description: 'VPS para Streaming com processadores AMD Ryzen e Proteção Anti DDoS para aplicações de alto nível e servidores de jogos.',
        images: ['/banner.webp'],
    },
    icons: {
