    ...
    <>
      <section className="container mx-auto max-w-9xl pt-10 flex-grow">
        <div className="pt-[5%]">
          ...
          <p className="text-md">Seu arsenal completo para construir e controlar seus servidores de jogos.</p>
          ...
          <section className="pt-5">
            <div className="flex flex-wrap justify-between gap-4">
              {benefits.benefits.map((item, index) => (
                <CardBenefitsComponent key={index} icon={item.icon} title={item.title} content={item.description} />
              ))}
            </div>
          </section>
        </div>
        ...
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-[10%]">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="rounded-xl overflow-hidden shadow-xl transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-2xl">
              <Image
