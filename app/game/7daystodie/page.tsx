...
export default function Games() {
    ...
    useEffect(() => {
        const findGame = games.filter((item) => item.id === 3 );
    ...
    return (
        <section className="container mx-auto px-6 flex-grow pt-[2%]">
            ...
            {displayGame ? <TabsComponent displayGame={{ ...displayGame, displayName: "Crie seu servidor de 7 Days to Die", name: "7 Days to Die" }} /> : ""}
            </div>
                            ...
                            <CardBody>
                                <div className="p-4">
                                    ...
                                    <p className="text-gray-300 text-[14px]">
                                        A razehost e incrível, custo benefício e um belo suporte, tanto pra colocar mods e essas coisas, recomendo e irei utilizar muito
                                    </p>
                                </div>
                            </CardBody>
                        </Card>
                        <Card className="bg-[#202024] rounded-lg">
                            <CardBody>
                                <div className="p-4">
                                    ...
                                    <Divider className="mt-3 mb-3" />
                                    <p className="text-gray-300 text-[14px]">
                                        Já uso a empresa para hospedar servidores a anos GRA RP, servidores Linux, hoje estou até mesmo com meu banco de dados hospedado, sem quedas e SLA perfeito.
                                    </p>
                                </div>
                            </CardBody>
                        </Card>
                        <Card className="bg-[#202024] rounded-lg">
                            <CardBody>
                                <div className="p-4">
                                    ...
                                    <Divider className="mt-3 mb-3" />
                                    <p className="text-gray-300 text-[14px]">
                                        Razehost com suporte e jogos top para jogar, já contratei outros, mas esse servidor está muito bom e com equipamentos muito bons também.
                                    </p>
                                </div>
                            </CardBody>
                        </Card>
