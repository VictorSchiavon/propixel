    ...
    const fallbackPlans = [
        {
            ...
            link: "#",
            description: ["10GB RAM", "Suporte a Mods", "Configuração Personalizada", "Subdomínio GRÁTIS", "SSD NVMe"],
        ...
        },
        {
            ...
            link: "#",
            description: ["14GB RAM", "Suporte a Mods", "Configuração Personalizada", "Subdomínio GRÁTIS", "SSD NVMe"],
            img: displayGame?.wallpaper || "/placeholder.svg"
        },
        {
            name: "Plano Ultimate",
            price: "R$308,68",
            discountPrice: "R$209,90",
            link: "#",
            description: ["32GB RAM", "Suporte a Mods", "Configuração Personalizada", "Domínio GRÁTIS", "SSD NVMe"],
            img: displayGame?.wallpaper || "/placeholder.svg"
        }
    ];
