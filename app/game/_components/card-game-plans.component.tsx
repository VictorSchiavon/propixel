			...
			<Card className="bg-[#202024] border-none rounded-lg h-[700px]">
				<CardBody className="overflow-visible p-0 border-none bg-[#0E131D] h-full flex flex-col">
					...
					<div className="pt-5 p-4 flex-grow">
						...
						<div className="pt-5">
							{features?.map((item, index) => (
								<p
									key={index}
									className="text-md text-gray-200 pb-2 flex gap-3"
								>
									<BiCheck size={20} />
									<span>{item}</span>
								</p>
					...
					<div className="pt-5 mt-auto mb-5 p-4">
						...
						<Button className="text-white bg-orange-400 w-full">
							Visualizar planos
						</Button>
						<Button className="text-white w-full mt-2" variant="bordered">
