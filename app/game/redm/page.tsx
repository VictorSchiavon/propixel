	...
	return (
		<section className="container mx-auto px-6 flex-grow pt-[2%]">
			...
			<div className="rounded-xl shadow-lg mt-12 p-5 bg-[#202024]">
				<h2 className="text-lg font-semibold">Qual a melhor host para Redm?</h2>
				<p className="text-gray-400">
					A Raze Host é referência em hospedagem de alto desempenho, garantindo
					baixa latência e estabilidade máxima. Com proteção DDoS avançada,
					mitigamos ataques Layer 7, assegurando a segurança e o desempenho
					ideal do seu servidor mesmo em momentos críticos.
				</p>
			</div>
