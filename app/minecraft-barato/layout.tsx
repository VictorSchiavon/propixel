...
export const metadata: Metadata = {
    title: "Host de Minecraft Barato | AMD Ryzen 9",
    description: "Hospede seu servidor de Minecraft no Brasil e barato com suporte para Java e Bedrock. Painel fácil de usar, instalação de mods, proteção Anti DDoS e desempenho incrível para jogar com amigos.",
    keywords: [
        "RazeHost.com.br",
        "RazeHost",
        "hospedagem de minecraft barato",
        "host minecraft barato",
    ...
    openGraph: {
        title: 'Host de Minecraft Barato | RazeHost',
        ...
        url: 'https://www.razehost.com.br/minecraft-barato',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "WebPage",
                        name: "Host de Minecraft Barato | Java e Bedrock",
                        description:
