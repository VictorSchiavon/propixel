...
export const metadata: Metadata = {
    title: {
        default: "Host de Hytale no Brasil",
        template: `%s - ${siteConfig.name}`,
    },
    description: "Crie seu servidor de Hytale na RazeHost, rode seu servidor com mods, plugins, e a versão que quiser, servidor de Hytale é na RazeHost.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'A melhor hospedagem de Hytale no Brasil | AMD Ryzen 9 | RazeHost',
        description: 'Crie seu servidor de Hytale na RazeHost, rode seu servidor com mods, plugins, e a versão que quiser, servidor de Hytale é na RazeHost.',
