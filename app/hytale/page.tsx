        ...
        <>
            <section className="container mx-auto px-6 flex-grow">
                <section className="pt-[5%]">
                    <h1 className="text-6xl font-bold pt-4">Crie seu servidor de Hytale</h1>
                    <p className="text-muted pt-5 pb-5">
                    Ofereça uma experiência de jogo sem interrupções com servidores dedicados para Hytale, com alta performance e estabilidade. Todos os nossos servidores estão localizados em São Paulo, garantindo baixa latência e conexão rápida para jogadores do Brasil. Com suporte para diversas versões do Hytale, incluindo Java e Bedrock, além de compatibilidade com mods e plugins populares, seu servidor estará sempre otimizado para a melhor jogabilidade. Seja para jogar sozinho ou com uma grande comunidade, temos a solução perfeita para seu servidor de Hytale, com recursos escaláveis e confiabilidade garantida.                    </p>
                    <div className="pt-5 flex gap-3">
                    <Button className="rounded-md bg-transparent text-white border" onClick={() => window.location.href = 'https://discord.gg/p8YXcEuKdH'}>Ver planos</Button>
                        ...
                        <Card className="bg-[#0A0C10] rounded-sm">
                            <CardBody>
                                <div>
                                    ...
                                    <h3 className="font-bold pt-3">Proteção DDoS para Servidores de Hytale</h3>
                                    <p className="text-gray-300 text-[14px] pt-1">Mantenha seu servidor de Hytale sempre online com nossa proteção DDoS avançada, ideal para evitar lag e quedas durante ataques.</p>
                                </div>
                            </CardBody>
                        </Card>
                        <Card className="bg-[#0A0C10] rounded-sm">
                            <CardBody>
                                <div>
                                    ...
                                    <h3 className="font-bold pt-3">Hospedagem Hytale com Suporte a Mods e Plugins</h3>
                        ...
                        <Card className="bg-[#0A0C10] rounded-sm">
                            <CardBody>
                                <div>
                                    ...
                                    <h3 className="font-bold pt-3">Compatível com Todas as Versões de Hytale</h3>
                                    <p className="text-gray-300 text-[14px] pt-1">Desde as versões mais antigas até as mais recentes, nossos servidores suportam Hytale Vanilla, Spigot, Paper, Bukkit e Bedrock.</p>
                                </div>
                            </CardBody>
                        </Card>
                    </div>
            ...
            <section className="bg-[#07090c] mt-10 p-5">
                <div className="container mx-auto px-6 flex-grow pt-10">
                    <section>
                        <h2 className="text-4xl font-bold">Hytale Java e Bedrock em um Só Lugar</h2>
                            ...
                            <Card className="bg-[#0A0C10] rounded-sm">
                                <CardBody>
                                    <div>
                                        ...
                                        <h3 className="font-bold text-center pt-3">Escalabilidade para Grandes Comunidades de Hytale</h3>
