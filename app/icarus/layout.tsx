...
export const metadata: Metadata = {
    title: "Host de Icarus no Brasil",
    description: "A melhor hospedagem de Icarus no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'Host de Icarus - Hospedagem de Icarus | RazeHost',
        description: 'A melhor hospedagem de Icarus no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.',
        url: 'https://www.razehost.com.br/icarus',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
