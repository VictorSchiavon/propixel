    ...
    return (
        <section className="container mx-auto px-6 flex-grow pt-[2%]">
            ...
            <div className="pt-[5%]" id="jogos">
                {swiperInstance && (
                    <div className="flex justify-between pt-4 pb-4">
                        ...
                        <div className="flex gap-2">
                            <Button onClick={() => swiperInstance.slidePrev()} isIconOnly aria-label="Prev" size="sm" className="bg-[#0E131D] border border-neutral-600">
                                <LucideArrowLeft color="orange" size={15} />
                            </Button>
                            <Button onClick={() => swiperInstance.slideNext()} isIconOnly aria-label="Next" size="sm" className="bg-[#0E131D] border border-neutral-600">
            ...
            <div className="pt-[5%]" id="jogosnovos">
                <h1 className="text-xl font-bold pt-2">Novos Jogos</h1>
                <Swiper
                    slidesPerView={4}
                    spaceBetween={30}
                    loop={true}
