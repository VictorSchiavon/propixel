...
export function calculateDiscountPercentage(originalPrice: number, discountPrice: number | null): number {
...
export const CardGameComponent = ({ name, img, link, price, priceDiscount }: any) => {
    return (
        <>
            <Link href={link}>
                <Card className="bg-[#0B0E13] border-none shadow-none">
                    <CardBody className="overflow-visible p-0 border-none bg-transparent">
                        ...
                        <div className="pt-2 pl-2">
                            ...
                            {!priceDiscount ? (
                                <p className="truncate md:whitespace-normal">A partir de {price}</p>
                            ) : (
