        ...
        <>
            <section className="container mx-auto px-6 flex-grow">
                <section className="pt-[5%]">
                    <h1 className="text-6xl font-bold pt-4">Crie seu servidor de Palworld Xbox</h1>
                    <p className="text-muted pt-5 pb-5">
                    Ofereça uma experiência de jogo sem interrupções com servidores dedicados para Palworld, com alta performance e estabilidade. Todos os nossos servidores estão localizados em São Paulo, garantindo baixa latência e conexão rápida para jogadores do Brasil. Com suporte para diversas versões do Palworld, além de compatibilidade com mods e plugins populares, seu servidor estará sempre otimizado para a melhor jogabilidade. Seja para jogar sozinho ou com uma grande comunidade, temos a solução perfeita para seu servidor de Palworld, com recursos escaláveis e confiabilidade garantida.                    </p>
                        ...
                        <Card className="bg-[#0A0C10] rounded-sm">
                            <CardBody>
                                <div>
                                    ...
                                    <h3 className="font-bold pt-3">Proteção DDoS para Servidores de Palworld</h3>
                                    <p className="text-gray-300 text-[14px] pt-1">Mantenha seu servidor de Palworld sempre online com nossa proteção DDoS avançada, ideal para evitar lag e quedas durante ataques.</p>
                                </div>
                            </CardBody>
                        </Card>
                        <Card className="bg-[#0A0C10] rounded-sm">
                            <CardBody>
                                <div>
                                    ...
                                    <p className="text-gray-300 text-[14px] pt-1">Oferecemos servidores totalmente compatíveis com mods (não para Xbox e sim para Steam), a verificar otimização de mods para não ter problemas.</p>
                                </div>
                            </CardBody>
                        </Card>
                        <Card className="bg-[#0A0C10] rounded-sm">
                            <CardBody>
                                <div>
                                    ...
                                    <p className="text-gray-300 text-[14px] pt-1">Todas as atualizações de Palworld são feitas de forma automática ao reiniciar o servidor.</p>
                                </div>
                            </CardBody>
                        </Card>
                    </div>
            ...
            <section className="bg-[#07090c] mt-10 p-5">
                <div className="container mx-auto px-6 flex-grow pt-10">
                    <section>
                        ...
                        <p className="text-muted pt-2 pb-5">Configure servidores para Xbox em um único painel, com fácil gerenciamento e recursos avançados. <span className="text-orange-400">Jogue XBOX!</span></p>
                            ...
                            <Card className="bg-[#0A0C10] rounded-sm">
                                <CardBody>
                                    <div>
                                        ...
                                        <h3 className="font-bold text-center pt-3">Escalabilidade para Grandes Comunidades de Palworld</h3>
                                        <p className="text-gray-300 text-[14px] pt-1 text-center">
                                        Seja para um servidor pequeno ou uma grande rede, oferecemos planos que se ajustam ao tamanho da sua comunidade.
                                        </p>
                                    </div>
                                </CardBody>
                            </Card>
