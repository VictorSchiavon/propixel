...
export const metadata: Metadata = {
    title: {
        default: "Host de Palworld Xbox no Brasil",
        template: `%s - ${siteConfig.name}`,
    },
    description: "A melhor host de Palworld no Brasil, crie seu servidor, configure e personalize do jeito que desejar com nosso gamepanel.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'Host de Palworld Xbox no Brasil',
        ...
        url: 'https://razehost.com.br/palworldxbox',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
