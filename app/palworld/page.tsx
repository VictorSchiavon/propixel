			...
			<section className="container mx-auto px-6 flex-grow">
				<section className="pt-[5%]">
					...
					<p className="text-muted pt-5 pb-5">
						...
						suporte para diversas versões do Palworld, incluindo Xbox e Steam,
						além de compatibilidade com mods e plugins populares, seu servidor
						estará sempre otimizado para a melhor jogabilidade. Seja para jogar
						sozinho ou com uma grande comunidade, temos a solução perfeita para
						seu servidor de Palworld, com recursos escaláveis e confiabilidade
						garantida.{" "}
					</p>
						...
						<Card className="bg-[#0A0C10] rounded-sm">
							<CardBody>
								<div>
									...
									<h3 className="font-bold pt-3">
										Hospedagem Palworld com Suporte a Mods
									</h3>
									<p className="text-gray-300 text-[14px] pt-1">
										Oferecemos servidores totalmente compatíveis com mods, a
										verificar otimização de mods para não ter problemas.
									</p>
								</div>
							</CardBody>
						</Card>
				...
				<div className="rounded-xl shadow-lg mt-12 p-5 bg-[#202024]">
					<h2 className="text-lg font-semibold">
						Qual a melhor host para Palworld?
					</h2>
