                        ...
                        <Card className="bg-[#0A0C10] rounded-sm">
                            <CardBody>
                                <div>
                                    ...
                                    <h3 className="font-bold pt-3">Hospedagem Palworld com Suporte a Mods</h3>
                                    <p className="text-gray-300 text-[14px] pt-1">Oferecemos servidores totalmente compatíveis com mods, a verificar otimização de mods para não ter problemas.</p>
                                </div>
                            </CardBody>
                        </Card>
                        <Card className="bg-[#0A0C10] rounded-sm">
