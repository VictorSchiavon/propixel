...
export const metadata: Metadata = {
  title: "Host de Minecraft no Brasil | Servidores de Minecraft | NexusHost",
  description:
    "Hospedagem de servidores Minecraft no Brasil com alta performance, proteção DDoS e suporte 24/7. Ative seu servidor em segundos!",
  keywords:
    "minecraft, host minecraft, servidor minecraft, hospedagem minecraft brasil, minecraft server, minecraft hosting",
}
...
export default function MinecraftPage() {
  ...
  const jogosSimilares = [
    { id: "terraria", title: "Terraria", category: "Sandbox" },
    { id: "stardew-valley", title: "Stardew Valley", category: "Sandbox" },
    { id: "core-keeper", title: "Core Keeper", category: "Sandbox" },
    { id: "valheim", title: "Valheim", category: "Survival" },
    { id: "ark-survival-evolved", title: "ARK: Survival Evolved", category: "Survival" },
  ]
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  <Badge className="mb-2 bg-yellow-500 hover:bg-yellow-600 text-black">Sandbox</Badge>
                  <h1 className="text-3xl font-bold">Minecraft</h1>
                  <p className="text-gray-400 mt-2">
                    Hospedagem de servidores de Minecraft com alta performance e estabilidade. Suporte para plugins,
                    mods e versões personalizadas.
                  </p>
                </div>
