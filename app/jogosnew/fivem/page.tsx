...
export const metadata: Metadata = {
  title: "Host de FiveM no Brasil | Servidores GTA V FiveM | NexusHost",
  description:
    "Hospedagem de servidores FiveM no Brasil com alta performance, proteção DDoS e suporte 24/7. Crie seu servidor de roleplay GTA V hoje!",
  keywords: "fivem, gta v, host fivem, servidor fivem, hospedagem fivem brasil, gta roleplay, fivem server",
}
...
export default function FiveMPage() {
  ...
  const planos = [
    {
      id: 1,
      title: "FiveM Básico",
      description: "Ideal para servidores pequenos com até 32 jogadores",
      price: "R$ 59,99",
    ...
    },
    {
      id: 2,
      title: "FiveM Padrão",
      description: "Perfeito para servidores médios com até 64 jogadores",
      price: "R$ 99,99",
      features: [
        "8GB RAM",
        "64 Slots",
    ...
    },
    {
      id: 3,
      title: "FiveM Premium",
      description: "Ideal para servidores grandes com até 128 jogadores",
      price: "R$ 149,99",
      features: [
        "16GB RAM",
        "128 Slots",
  ...
  const jogosSimilares = [
    { id: "redm", title: "RedM", category: "Roleplay" },
    { id: "arma3", title: "Arma 3", category: "Shooter" },
    { id: "rust", title: "Rust", category: "Survival" },
    { id: "dayz", title: "DayZ", category: "Survival" },
    { id: "palworld", title: "Palworld", category: "Survival" },
  ]
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  <Badge className="mb-2 bg-yellow-500 hover:bg-yellow-600 text-black">Roleplay</Badge>
                  <h1 className="text-3xl font-bold">FiveM</h1>
                  <p className="text-gray-400 mt-2">
                    Hospedagem de servidores FiveM com alta performance e estabilidade. Crie seu próprio servidor de
                    roleplay GTA V com facilidade.
                  </p>
                </div>
