...
export const metadata: Metadata = {
    title: "Host de Barotrauma no Brasil",
    description: "A melhor hospedagem de Barotrauma no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'Host de Barotrauma - Hospedagem de Barotrauma | RazeHost',
        description: 'A melhor hospedagem de Barotrauma no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.',
        url: 'https://www.razehost.com.br/barotrauma',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
