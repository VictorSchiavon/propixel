...
export const metadata: Metadata = {
    title: "Host de MTA no Brasil",
    description: "A melhor hospedagem de Multi Theft Auto no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'Host de MTA - Hospedagem de Multi Theft Auto | RazeHost',
        ...
        url: 'https://www.razehost.com.br/mta',
        siteName: 'RazeHost',
        images: ['/banner.webp']
    },
    twitter: {
        ...
        title: 'Host de MTA - Hospedagem de Multi Theft Auto | RazeHost',
        description: 'A melhor hospedagem de MTA no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.',
        images: ['/banner.webp'],
    },
    icons: {
        icon: "/favicon.ico",
