...
export const metadata: Metadata = {
    title: {
        default: "Host de Dune: Awakening no Brasil",
        template: `%s - ${siteConfig.name}`,
    },
    description: "Crie seu servidor de Dune: Awakening na RazeHost, rode seu servidor com a melhor performance e proteção, servidor de Dune: Awakening é na RazeHost.",
    keywords: [
        "RazeHost.com.br",
        "RazeHost",
        "Raze Host",
    ...
    openGraph: {
        title: 'A melhor hospedagem de Dune: Awakening no Brasil | AMD Ryzen 9 | RazeHost',
        description: 'Crie seu servidor de Dune: Awakening na RazeHost, rode seu servidor com a melhor performance e proteção, servidor de Dune: Awakening é na RazeHost.',
