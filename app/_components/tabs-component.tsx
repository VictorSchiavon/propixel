	...
	return (
		<>
			...
			>
								...
								<>
									...
									<div className="col-span-1 md:col-span-9 mt-3">
										...
										<div className="pt-10 grid grid-cols-1 md:grid-cols-12 gap-8">
											...
											<div className="col-span-1 md:col-span-6 md:border-l-2 border-gray-600">
												<p className="text-gray-500 text-sm md:pl-4">
													Informações
												</p>
									...
									<div className="col-span-1 md:col-span-3">
										...
										<div className="pt-3">
											...
											>
												<Button className="text-white bg-slate-800 w-full mt-2">
													Comunidade
												</Button>
											</a>
				...
				{/* Tab de planos */}
				<Tab key="plans" title="Planos" className="-mx-2">
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-10">
						{getPlans(
							plans,
							displayGame.name.toLowerCase().replace(/\s+/g, ""),
