...
export const metadata: Metadata = {
    title: "Host de Core Keeper no Brasil",
    description: "A melhor hospedagem de Core Keeper no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.",
  keywords: [
    "RazeHost.com.br",
    "RazeHost",
    "Raze Host",
    ...
    openGraph: {
        title: 'Host de Core Keeper - Hospedagem de Core Keeper | RazeHost',
        description: 'A melhor hospedagem de Core Keeper no Brasil com o melhor painel de gerenciamento, instale mods, convide seus amigos e se divirta-se com o alto desempenho da Host.',
