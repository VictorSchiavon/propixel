...
const sections = [
    { title: "Servidores", links: [{ name: "Servidores VPS", url: "/vps" }, { name: "VPS FiveM", url: "/fivem" }, { name: "Semidedicados", url: "/semidedicados" }, { name: "Servidores Dedicados", url: "/dedicados" }, { name: "VPS Trader", url: "/vps-trader" }] },
