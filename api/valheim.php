<?php
    ...
    // Variáveis da página    
    $__title      = "Host de Valheim no Brasil | HydraHost";
    $__meta_title = "Servidores VPS para Jogos | Datacenter no Brasil";    
    $__meta_description = "A melhor Host de Valheim no Brasil, processadores AMD Ryzen e servidores localizados no Brasil com Proteção Anti DDoS.";
    ...
    <div class="container position-relative">
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-8">
          ...
          <!-- title-1 -->
          <h1 class="title-1">A melhor Host de Valheim no Brasil</h1>
          <!-- para-1 -->
          <p class="para-1 mb-3">Servidores equipados com os hardwares recentes do mercado, Host de Valheim - AMD Ryzen, discos SSD NVMe M.2 M.2, adquira seu teste agora.</p>
          <!-- btn -->
  ...
  <div class="se-i py-120 bg-2" id="se-i">
    <div class="container">
      ...
      <div class="se-head mb-5">
        <h3 class="se-title-1">Hospedagem de Valheim no Brasil</h3>
